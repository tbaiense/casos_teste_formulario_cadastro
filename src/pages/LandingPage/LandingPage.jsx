      ...
      <div>
        ...
        <main className={style.conteudo}>
          <section className={style.introducao}>
            ...
            <p>
              Na TechSecure, sua privacidade é nossa prioridade. Com tecnologia
              avançada, protegemos seus dados contra ameaças. Confie em quem
          ...
          <div>
            <img
              src={sideImg}
              alt="Imagem de um segurança ao lado de um computador"
